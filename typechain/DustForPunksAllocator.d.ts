...
interface DustForPunksAllocatorInterface extends ethers.utils.Interface {
  functions: {
...
export class DustForPunksAllocator extends BaseContract {
  ...
  interface: DustForPunksAllocatorInterface;
